...
async function sendToBackend(data) {
  ...
  const res = await activitiesService.addActivities(post);
...
async function showAll() {
  news = await activitiesService.getAllActivities();
...
async function deletePost(id) {
  const res = await activitiesService.deleteActivities(id);
